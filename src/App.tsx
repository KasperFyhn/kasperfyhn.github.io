...
function NavBar() {
    ...
    return (<div className={'navbar'}>
        ...
        <Link to={"https://www.linkedin.com/in/kasper-fyhn/"} target={"_blank"}>
            <img className={'white-image'} height={"20px"} src={LinkedIn} alt={"LinkedIn"}/>
        </Link>
        <Link to={"https://github.com/KasperFyhn"} target={"_blank"}>
            <img className={'white-image'} height={"20px"} src={GitHub} alt={"LinkedIn"}/>
        </Link>
    </div>)
}
        ...
        <HashRouter>
            ...
            <div className="root">
                ...
                <Routes>
                    ...
                    <Route path="/about" element={<Content><AboutPage/></Content>}/>
                </Routes>
            </div>
        </HashRouter>
    );
